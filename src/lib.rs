...
pub use config::{
    ...
    create_runweaver_definition_manifest, define_config, define_config_with, define_runweaver,
    define_runweaver_with, deny, file_target_policy, file_target_verdict, file_targets,
...
pub use surfaces::agent_hooks::{
    ...
    CodexCodec, CompiledRunweaverHookCommandOptions, Harness, HarnessCodec, HarnessDefinition,
    HarnessError, HarnessHookCommand, HarnessHookConfig, HarnessHookConfigCheckResult,
    HarnessHookConfigError, HarnessHookConfigMismatch, HarnessHookConfigRegistry,
    HarnessHookConfigRenderFn, HarnessHookConfigRenderInput, HarnessHookConfigSet, HarnessHookFile,
    HarnessHookGroup, HarnessOptions, HarnessRegistry, HarnessTarget, HarnessTargetInput,
    HarnessTargetValidationFn, HookApp, HookBinding, HookBindingInput, HookBindingValidationFn,
    HookBindingValidationInput, HookCommandCatalog, HookCommandError, HookCommandInput,
    HookCommandPrefixError, HookCommandSpec, HookConfigCommand, HookEmission, HookEnv, HookError,
    HookEvent, HookEventField, HookEventFieldValue, HookFeedbackOutcome, HookFn, HookInputError,
    HookOutcome, HookProcedure, HookRequest, HookStage, HookStopSessionInput,
    HookTouchedPathsInput, LoadAgentHooksConfigRequest, ParsedAgentHooksConfigArgs,
    ProjectedHookCommandOptions, RunHookInput, RuntimeServicesFactory, RuntimeServicesRunner,
    RunweaverHookCommandCwd, RunweaverHookCommandOptions, TaskHook, TaskHookCwdFn, TaskHookFilesFn,
    TaskHookFormatFailureFn, TaskHookRunner, TaskHookRunnerOptions, TaskHookRunnerSource,
    UpdatedFileSnapshot, agent_hooks_config_usage, block_reason_outcome,
    check_harness_hook_config_files, claude_harness, claude_harness_hook_config, codex_harness,
    codex_harness_hook_config, compiled_runweaver_hook_command, create_hook_command_catalog,
    define_agent_hooks_app, define_agent_hooks_config, define_harness, define_harness_hook_config,
    define_hook, define_hook_command, define_task_hook, execute_hook_command, feedback_outcome,
    format_task_run_as_hook_block_reason, harness_hook_config_registry_from_harnesses,
    harness_registry_from_harnesses, hook_command_input, hook_failure_reason,
    hook_feedback_from_task_run, hook_groups_by_stage, hook_stop_session_input,
    hook_tool_touched_paths_input, is_hook_feedback_outcome, optional_bool, optional_string,
    outcome_to_emission, parse_agent_hooks_config_args, parse_payload,
    render_harness_hook_config_files, require_event_name, require_hook_event_field, require_object,
    require_present_field, require_string, run_agent_hooks_config_process_main,
