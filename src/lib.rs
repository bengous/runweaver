...
pub use cli::{
    ...
    RunweaverParsedOptions, RunweaverStdin, compiled_runweaver_project,
    load_generic_runweaver_project, parse_runweaver_options, run_compiled_runweaver_cli,
    run_compiled_runweaver_cli_with_compile, run_compiled_runweaver_project_cli,
    run_compiled_runweaver_project_cli_with_compile, run_generic_runweaver_cli, run_runweaver_cli,
    runweaver_help_text,
};
...
pub use config::{
    ...
    GENERATED_GIT_HOOKS_DIR, GeneratedSurfaceFile, GitFilesScopeManifest, GitPipelineSlotManifest,
    GitPreCommitSlotManifest, GitSurfaceManifest, GitToolSlotManifest, GithubCiSurfaceManifest,
    HarnessRef, HarnessTargetManifest, HookAppBuilder, HookBindingManifest, HookCommandBuilder,
    ...
    file_target_verdict, file_targets, generic_runweaver_project_binary, harness_ref, hook_app,
    hook_command, hook_command_ref, host_command, is_blocking_completion,
...
pub use surfaces::agent_hooks::{
    ...
    AgentHooksConfigHook, AgentHooksProcessIo, AgentHooksStdin, AgentsSurfaceDefaults,
    BuiltInHarnessName, ClaudeCodec, CodexCodec, CompiledRunweaverHookCommandOptions,
    DESTRUCTIVE_COMMAND_MERGE_HINT, Harness, HarnessCodec, HarnessDefinition, HarnessError,
    ...
    HarnessOptions, HarnessRegistry, HarnessTarget, HarnessTargetInput, HarnessTargetValidationFn,
    HookApp, HookBinding, HookBindingInput, HookBindingValidationFn, HookBindingValidationInput,
    HookCommandCatalog, HookCommandError, HookCommandInput, HookCommandPrefixError,
    HookCommandSpec, HookConfigCommand, HookEmission, HookEnv, HookError, HookEvent,
    HookEventField, HookEventFieldValue, HookFeedbackOutcome, HookFn, HookInputError, HookOutcome,
    HookProcedure, HookRequest, HookStage, HookStopSessionInput, HookTouchedPathsInput,
    LoadAgentHooksConfigRequest, ParsedAgentHooksConfigArgs, ProjectedHookCommandOptions,
    RunHookInput, RuntimeServicesFactory, RuntimeServicesRunner, RunweaverHookCommandCwd,
    RunweaverHookCommandOptions, TaskHook, TaskHookCwdFn, TaskHookFilesFn, TaskHookFormatFailureFn,
    TaskHookRunner, TaskHookRunnerOptions, TaskHookRunnerSource, UpdatedFileSnapshot,
    agent_hooks_config_usage, block_reason_outcome, check_destructive_command,
    check_destructive_merge, check_harness_hook_config_files, claude_harness,
    claude_harness_hook_config, codex_harness, codex_harness_hook_config,
